...
/**
 * 
 * Class that represents a script that can be executed. Contains helper methods that might be useful for writing a script.
 * 
 * @author aliu
 *
 */
public abstract class Script implements Runnable {
	...
	public final void run() {
		...
		} catch (Exception e) {e.printStackTrace();onQuit();}
	}
	...
	/**
	 * Gets the time in the military time format, starting with 0000 at midnight and ending with 2359 at 11:59 pm
	 * @return military time
	 */
	public static int getMilitaryTime() {
		return 100*getHour()+getMinute();
	}
	
	/**
	 * Returns an integer representing the day of the week, where 0 is Sunday and 6 is Saturday
