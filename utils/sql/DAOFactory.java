...
javabase.jdbc.url = jdbc:mysql://localhost:3306/javabase?verifyServerCertificate=false&useSSL=true
...
javabase.jdbc.password = java
	...
	/**
     * <pre>
     * Returns a new DAOFactory instance for the given database name. Example usage:  
     * 
     * <code>
     * String url = "jdbc:mysql://localhost:3306/javabase?verifyServerCertificate=false&useSSL=true";
     * String driverName = "com.mysql.jdbc.Driver";
     * String username = "username";
     * String password = "password";
     * DAOFactory daoFactory = DAOFactory.getInstance(url,driverName, username, password);
     *</code></pre>
     * @param url url to load from
     * @param driverClassName class name of the driver
     * @param username username to access database
     * @param password password to access database
     * @return A new DAOFactory instance at the given url, with the given driver class
     * @throws DAOConfigurationException If either the driver cannot be loaded or the datasource cannot be found.
     */
    public static DAOFactory getInstance(String url, String driverClassName) throws DAOConfigurationException {
     ...
     * @return A new DAOFactory instance at the given url, with the given driver class (if specified)
     * @throws DAOConfigurationException If either the driver cannot be loaded or the datasource cannot be found.
     */
    public static DAOFactory getInstance(String url, String driverClassName, String username, String password) throws DAOConfigurationException {
