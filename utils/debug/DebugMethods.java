...
public final class DebugMethods {
	...
	private static Timer sysTimer;//TODO add counters to do more runtime analysis i.e. timers have a .count() method or something like that, and the count can be outputted (if it is used)
	...
	public static void print(Object o) {
		...
		PRINT_STREAM.printf("Object class: <%s>%nObject value: [%s]%nPrint Called at: %s",outputClass,output,stackString());//prints out the location of where this statement was called
	}
	...
	/**
	 * Changes the PrintStream that DebugMethods methods print to (System.out by default)
	...
	/**
	 * Changes the InputStream that DebugMethods methods get input from (System.in by default)
