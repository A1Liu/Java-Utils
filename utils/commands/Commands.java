...
public class Commands {
	 ...
	 */
	public final Object input(String[] in) {//TODO Need to account for 'null' branch. Also need to create new help commands that also account for null.
	...
	public SkipC getSkip(String... path) {
