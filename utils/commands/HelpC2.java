...
/**
 * This class represents a command that outputs a guide to a command tree. Deprecated version, code available until the new version is confirmed as stable n stuff
 * @deprecated
 * @author aliu
 *
 */
