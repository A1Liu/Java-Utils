 ...
 * @param <E>
 */
abstract class Accessor<E extends Comparable<E>> {// TODO Make accessor extend List
	...
	/**
	 * Compares 2 elements, one of which is an index, the other of which is an element
