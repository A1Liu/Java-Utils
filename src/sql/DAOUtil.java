...
public class DAOUtil {
	...
	*/
	 ...
	 */
	public static String buildSelect(String columns, String table, String conditions) {
	 ...
	 * Builds a SELECT query from given parameters. Uses format <br>
	 * <code>
	 * SELECT &lt;columns&gt; FROM &lt;table&gt; WHERE &lt;conditions&gt; &lt;additional&gt;
	 * </code>
	 * @param columns the columns to select
	 * @param table the table to query from
	 * @param conditions the conditions to query the table by
	 ...
	 * @return a formatted query
	 */
	public static String buildSelect(String columns, String table, String conditions, String additional) {
